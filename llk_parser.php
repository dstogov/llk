...
const YY__PERCENT_l_i_n_e_p_o_s = 8;
const YY__PERCENT_i_g_n_o_r_e_MINUS_s_c_a_n_n_e_r = 9;
const YY__PERCENT_i_g_n_o_r_e_MINUS_p_a_r_s_e_r = 10;
const YY__PERCENT_n_o_MINUS_m_a_i_n = 11;
const YY__PERCENT_c_MINUS_c_h_a_r = 12;
const YY__PERCENT_s_y_m_MINUS_t_y_p_e = 13;
const YY__PERCENT_c_h_e_c_k_MINUS_i_d = 14;
const YY__PERCENT_o_u_t_p_u_t = 15;
const YY__PERCENT_l_a_n_g_u_a_g_e = 16;
const YY__PERCENT_i_n_d_e_n_t = 17;
const YY__PERCENT_p_r_e_f_i_x = 18;
const YY_PROLOGUE = 19;
const YY_EPILOGUE = 20;
const YY__AT = 21;
const YY__RPAREN = 22;
const YY__COLON = 23;
const YY__SEMICOLON = 24;
const YY__COMMA = 25;
const YY_ATTR = 26;
const YY__BAR = 27;
const YY__AND = 28;
const YY__BANG = 29;
const YY__QUERY = 30;
const YY__QUERY_PLUS = 31;
const YY__QUERY_QUERY = 32;
const YY__PLUS = 33;
const YY__PLUS_PLUS = 34;
const YY__PLUS_QUERY = 35;
const YY__STAR = 36;
const YY__STAR_PLUS = 37;
const YY__STAR_QUERY = 38;
const YY__LPAREN = 39;
const YY__RBRACE = 40;
const YY__LBRACE = 41;
const YY_ACTION_CHAR = 42;
const YY_IDENT = 43;
const YY_IDENT_PLUS = 44;
const YY__SLASH = 45;
const YY__SLASH_SLASH = 46;
const YY__POINT = 47;
const YY__LBRACK = 48;
const YY__UPARROW = 49;
const YY__RBRACK = 50;
const YY_ESCAPE_CHAR = 51;
const YY_ESCAPE_CODE = 52;
const YY_SINGLE_CHAR = 53;
const YY__MINUS = 54;
const YY_STRING = 55;
const YY_EOL = 56;
const YY_WS = 57;
const YY_ONE_LINE_COMMENT = 58;
const YY_COMMENT = 59;
			...
			case 0:
				switch ($ch) {
											...
											if ($ch === "t") {
												...
												if ($ch === "y") {
													...
													if ($ch === "p") {
														...
														if ($ch === "e") {
															$pos++;
															return YY__PERCENT_s_y_m_MINUS_t_y_p_e;
														} else {
															$state = 183;
														}
													} else {
									...
									if ($ch === "c") {
										...
										if ($ch === "h") {
											...
											if ($ch === "a") {
												...
												if ($ch === "r") {
													$pos++;
													return YY__PERCENT_c_MINUS_c_h_a_r;
												} else {
													$state = 183;
												}
											} else {
											...
											if ($ch === "k") {
												...
												if ($ch === "-") {
													...
													if ($ch === "i") {
														...
														if ($ch === "d") {
															$pos++;
															return YY__PERCENT_c_h_e_c_k_MINUS_i_d;
														} else {
															$state = 183;
														}
													} else {
										...
										if ($ch === "e") {
											...
											if ($ch === "n") {
												...
												if ($ch === "o") {
													...
													if ($ch === "s") {
														$pos++;
														return YY__PERCENT_l_i_n_e_p_o_s;
													} else {
														$state = 183;
													}
												} else {
																	...
																	if ($ch === "n") {
																		...
																		if ($ch === "n") {
																			...
																			if ($ch === "e") {
																				...
																				if ($ch === "r") {
																					$pos++;
																					return YY__PERCENT_i_g_n_o_r_e_MINUS_s_c_a_n_n_e_r;
																				} else {
																					$state = 183;
																				}
																			} else {
																...
																if ($ch === "r") {
																	...
																	if ($ch === "s") {
																		...
																		if ($ch === "e") {
																			...
																			if ($ch === "r") {
																				$pos++;
																				return YY__PERCENT_i_g_n_o_r_e_MINUS_p_a_r_s_e_r;
																			} else {
																				$state = 183;
																			}
																		} else {
										...
										if ($ch === "m") {
											...
											if ($ch === "a") {
												...
												if ($ch === "i") {
													...
													if ($ch === "n") {
														$pos++;
														return YY__PERCENT_n_o_MINUS_m_a_i_n;
													} else {
														$state = 183;
													}
												} else {
					...
					case "\v":
						...
						break;
					case "\000":
						if ($ch === "\000" && $pos < $len) {$state = 183; break;};
						$pos++;
						return YY_EOF;
						break;
					default:
...
function parse_grammar($sym, $grammar) {
	while (in_array($sym, array(YY__PERCENT_s_t_a_r_t,YY__PERCENT_s_u_b_MINUS_s_t_a_r_t,YY__PERCENT_c_a_s_e_MINUS_s_e_n_s_e_t_i_v_e,YY__PERCENT_g_l_o_b_a_l_MINUS_v_a_r_s,YY__PERCENT_l_i_n_e_n_o,YY__PERCENT_l_i_n_e_p_o_s,YY__PERCENT_i_g_n_o_r_e_MINUS_s_c_a_n_n_e_r,YY__PERCENT_i_g_n_o_r_e_MINUS_p_a_r_s_e_r,YY__PERCENT_n_o_MINUS_m_a_i_n,YY__PERCENT_c_MINUS_c_h_a_r,YY__PERCENT_s_y_m_MINUS_t_y_p_e,YY__PERCENT_c_h_e_c_k_MINUS_i_d,YY__PERCENT_o_u_t_p_u_t,YY__PERCENT_l_a_n_g_u_a_g_e,YY__PERCENT_i_n_d_e_n_t,YY__PERCENT_p_r_e_f_i_x))) {
...
function parse_declaration($sym, $grammar) {
	switch ($sym) {
		...
		case YY__PERCENT_l_i_n_e_n_o:
			...
			break;
		case YY__PERCENT_l_i_n_e_p_o_s:
			$sym = get_sym();
			if ($sym == YY_TRUE) {
				$sym = get_sym();
				$grammar->linepos = true;
			} else if ($sym == YY_FALSE) {
				$sym = get_sym();
				$grammar->linepos = false;
			} else {
				error("unexpected '{$GLOBALS['sym_name'][$sym]}'");
			}
			break;
		case YY__PERCENT_i_g_n_o_r_e_MINUS_s_c_a_n_n_e_r:
			$sym = get_sym();
			if ($sym == YY_TRUE) {
				$sym = get_sym();
				$grammar->ignore_scanner = true;
			} else if ($sym == YY_FALSE) {
				$sym = get_sym();
				$grammar->ignore_scanner = false;
			} else {
				error("unexpected '{$GLOBALS['sym_name'][$sym]}'");
			}
			break;
		case YY__PERCENT_i_g_n_o_r_e_MINUS_p_a_r_s_e_r:
			$sym = get_sym();
			if ($sym == YY_TRUE) {
				$sym = get_sym();
				$grammar->ignore_parser = true;
			} else if ($sym == YY_FALSE) {
				$sym = get_sym();
				$grammar->ignore_parser = false;
			} else {
				error("unexpected '{$GLOBALS['sym_name'][$sym]}'");
			}
			break;
		case YY__PERCENT_n_o_MINUS_m_a_i_n:
			$sym = get_sym();
			if ($sym == YY_TRUE) {
				$sym = get_sym();
				$grammar->no_main = true;
			} else if ($sym == YY_FALSE) {
				$sym = get_sym();
				$grammar->no_main = false;
			} else {
				error("unexpected '{$GLOBALS['sym_name'][$sym]}'");
			}
			break;
		case YY__PERCENT_c_MINUS_c_h_a_r:
			$sym = get_sym();
			$sym = parse_string($sym, $s);
			$grammar->c_char = $s;
			break;
		case YY__PERCENT_s_y_m_MINUS_t_y_p_e:
			$sym = get_sym();
			$sym = parse_ident($sym, $id);
			$grammar->sym_type = $id;
			break;
		case YY__PERCENT_c_h_e_c_k_MINUS_i_d:
			$sym = get_sym();
			$sym = parse_ident($sym, $id);
			$grammar->check_id = $id;
			break;
